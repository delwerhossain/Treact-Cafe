  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        <Image style={styles.image} src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=768&q=80" />
