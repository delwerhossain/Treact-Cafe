...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-[#ba9aff] text-primary-content">
        <div>
        <Link to={'/'} className=" mb-8 normal-case md:text-5xl text-xl font-extrabold ">
          {" "}
          <span className="py-3 px-5  text-5xl text-white bg-[#580cfc]">T</span>{" "}
          Treact
        </Link>
          ...
          <p className="font-bold">
            Treact Industries Ltd. <br/>Providing Food since 1992
          </p> 
          <p>Copyright © 2023 - All right reserved</p>
        </div> 
        <div>
          <div className="grid grid-flow-col gap-4 text-[#580cfc]">
